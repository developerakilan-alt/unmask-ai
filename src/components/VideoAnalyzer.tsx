    ...
    <section className="glass rounded-3xl p-6 sm:sm:p-7">
      ...
      {file && (
        <motion.button
          ...
          onClick={run}
          disabled={running}
          className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-neon to-neon-600 px-6 py-3.5 text-sm font-bold text-black shadow-[0_0_24px_rgba(52, 211, 153,0.3)] transition-all hover:shadow-[0_0_32px_rgba(52, 211, 153,0.45)] disabled:cursor-not-allowed disabled:opacity-50"
        >
