    ...
    <section id="features" className="relative z-10 px-4 pb-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative mt-16">
          ...
          <div className="absolute left-1/2 top-0 bottom-0 hidden w-px -translate-x-1/2 bg-gradient-to-b from-neon/50 via-neon/15 to-transparent shadow-[0_0_14px_rgba(88,221,242,0.35)] sm:block" />

          <div className="space-y-8 sm:space-y-0 sm:grid sm:grid-cols-3 lg:grid-cols-5 sm:gap-5">
            {STEPS.map((step, i) => (
              <AnimatedSection key={step.title} delay={i * 150}>
                <div className="relative flex flex-col items-center text-center">
                  {/* Glass panel */}
                  <TiltCard max={6} glow className="w-full rounded-3xl">
                    <div className="glass relative w-full rounded-3xl p-6 transition-all duration-300 hover:border-white/60 hover:shadow-[0_16px_40px_rgba(2,14,28,0.5),0_0_26px_rgba(88,221,242,0.18)]">
                      ...
                      <div className="relative mx-auto grid h-16 w-16 place-items-center rounded-2xl border border-white/30 bg-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] transition-all group-hover:scale-110 hover:border-neon/60 hover:shadow-[0_0_26px_rgba(88,221,242,0.35)]">
                  ...
                  {i < STEPS.length - 1 && (
                    <div className="hidden sm:block mt-4">
                      <ArrowDown className="h-5 w-5 rotate-[-90deg] text-neon/60 drop-shadow-[0_0_8px_rgba(88,221,242,0.6)]" />
                    </div>
                  )}
                </div>
              </AnimatedSection>
