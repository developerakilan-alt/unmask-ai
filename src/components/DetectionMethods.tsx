        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {METHODS.map((method, i) => (
            <AnimatedSection key={method.title} delay={i * 80}>
              <div className="glass group relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:border-neon/30 hover:shadow-[0_0_30px_rgba(0,255,102,0.1)] hover:-translate-y-1">
