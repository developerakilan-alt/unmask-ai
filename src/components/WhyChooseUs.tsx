        ...
        <div className="mt-12 grid grid-cols-1 gap-3 sm:grid-cols-2">
          {FEATURES.map((feat, i) => (
            <AnimatedSection key={feat.text} delay={i * 60}>
              <TiltCard max={5} className="glass group flex items-center gap-4 rounded-2xl p-5 transition-all duration-300 hover:border-neon/30 hover:shadow-[0_0_20px_rgba(88,221,242,0.08)]">
