    ...
    <section className="glass rounded-3xl p-6 sm:sm:p-7">
      ...
      <div className="mt-5 flex items-center gap-2 rounded-2xl border border-neon/20 bg-neon/5 p-2">
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-xl bg-neon px-4 py-2 text-xs font-bold text-black transition-all hover:shadow-[0_0_20px_rgba(52, 211, 153,0.4)] disabled:cursor-not-allowed disabled:opacity-40"
        >
